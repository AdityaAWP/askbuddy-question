  ...
  const fetchQuestionsForCategory = async (categoryId: string) => {
    ...
    try {
      ...
      if (Array.isArray(data)) {
        ...
        console.error("Unexpected API response:", data)
        setTopic("Error loading questions.")
      }
    } catch (error) {
      ...
      <main className="flex-grow container mx-auto px-4 py-28">
        <section className="text-center mb-12">
          ...
          <p className="text-white max-w-2xl mx-auto">
            Kesulitan mencari topik saat nongkrong? askBuddy hadir untuk membantu kamu menemukan topik pembicaraan yang
            menarik berdasarkan situasi yang kamu hadapi.
          </p>
        </section>
            ...
            <div className="p-6">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="flex-grow py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors flex items-center justify-center"
